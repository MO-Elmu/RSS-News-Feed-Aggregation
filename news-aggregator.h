...
void getRssFeeds(std::string url, semaphore& s);

void getFeedArticles(Article artcl, semaphore& limit);
...
std::map<std::string, std::unique_ptr<semaphore>> serverLinksMap;
